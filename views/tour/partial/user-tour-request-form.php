...
<?= $form->field($GetTourForm, 'hotel_type')->checkboxList([0 => '', 1 => '', 2 => '', 3 => '', 4 => ''],
    ...
    <div class="form-group field-gettourform-nights">
        <label class="col-xs-11 col-xs-offset-1 control-label label-get-tour"><?=Yii::t('app', 'Night count');?></label>
...
<?= $form->field($GetTourForm, 'depart_country')->dropDownList($destinationCustomDropdown, ['prompt' => Yii::t('app','Choose destination')]);?>
