...
<div class="col-xs-12 flight-wrapper padding" data-flight-id="<?=$flight->id;?>">
    ...
    <div class="col-xs-12 body">
        ...
        <div class="col-xs-2 buttons">
            <div class="cost"><?= \app\models\Helper::break_string($flight->flight_cost, 3);?><span data-placement="bottom" data-toggle="tooltip" title="<?= $flight->owner->city->country->currency->hint;?>"> <?=$flight->owner->city->country->currency->name;?></span></div>
