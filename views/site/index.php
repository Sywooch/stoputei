    ...
    <div class="row">
        <div class="col-xs-12" id="control-tabs">
            <ul class="nav nav-tabs user" role="tablist">
                ...
                <li role="presentation" class="active"><span class="glyphicon glyphicon-fire icon-tab"></span><a href="#hot-tour" aria-controls="hot-tour" role="tab" data-toggle="tab" class="tour hotel"><?=Yii::t('app','Hot tours');?></a><span class="badge offers-tab tab-badge hot-tours"><?=count($userHotTours);?></span></li>
            </ul>
        ...
        <?= Html::a('', Url::toRoute(['flight/ajax-flight-list']), ['class' => 'ajax-flight-list']);?>
        <?= Html::a('', Url::toRoute(['tour/ajax-depart-cities-dropdown']), ['class' => 'ajax-depart-cities-dropdown']);?>
    </div>
</div>
