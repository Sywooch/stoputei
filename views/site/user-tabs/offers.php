...
<div class="row filter-tour">
    ...
    <div class="col-md-9 left-data">
        <div class="col-md-4 filter user-offers overflow-list">
            ...
            <?= $form->field($TourOffersForm, 'depart_city')->dropDownList($cityDropdown,['prompt' => Yii::t('app','Departure town')]);?>
    ...
    <div class="col-xs-12 full-hotel-information close-tab" data-tab-class="user-offers">
