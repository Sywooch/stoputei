...
return [
    ...
    'Company name' => 'Название компания',
    'Company city' => 'Город расположения компания',
    'Company phone' => 'Контактный телефон компания',
    'Company address' => 'Адрес компания',
    'Company street' => 'Улица/офис компания',
    ...
    'Approved' => 'Утвержден',
    'Budget' => 'Бюджет',
    'Manager region' => 'Регион туроператора',
    'Tourist was updated successful.' => 'Информация о Туристе была успешно обновлена.',
    'Manager was updated successful.' => 'Информация о Туроператоре была успешно обновлена.',
    ...
    'Get email about new managers' => 'Получать рассылку при регистрации новых туроператоров',
