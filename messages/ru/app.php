...
return [
    ...
    'Flight back' => 'Перелет обратно',
    'Voyage to is direct' => 'Перелет туда прямой',
    'Voyage is direct' => 'Прямой',
    'From date' => 'С',
    'To date' => 'По',
    'Budget' => 'Бюджет до',
    ...
    'Congratulations! Just now you have been created your response to tourist\s flight. Warning! All responses are actually only to ' => 'Предложение по авиабилету было успешно отправлено. Внимание, все запросы и предложения авиабилетов актуальны лишь до ',
    'Order' => 'Запрос',
    ...
    'Direct flight' => 'Только прямые рейсы',
    'Only regular flight' => 'Только регулярные рейсы',
    'Regular flight' => 'Только регулярные рейсы',
    'Flight\'s type' => 'Типы рейсов',
    'Request flight' => 'Запросить билеты',
    'Congratulations! Request on flights was submitted successfully.' => 'Запрос на авиаперелет был успешно отправлен. В течении скорого времени Тур фирмы из Вашего региона вышлют свои предложения. Внимание, данный запрос на авиабилет актуален лишь до ',
    ...
    'Лицензия Регион – активирует все сервисы только для региона регистрации Авиа/Тур агентства. Позволяет работать с туристами только из региона регистрации агентства. Агентство получает в свой кабинет запросы на туры и авиаперелет, отправленные туристами только из региона регистрации агентства. Горящие туры, опубликованные агентством, доступны туристам только из региона регистрации агентства.' => 'Лицензия Регион – активирует все сервисы только для региона регистрации Авиа/Тур агентства. Позволяет работать с туристами только из региона регистрации агентства. Агентство получает в свой кабинет запросы на туры и авиаперелет, отправленные туристами только из региона регистрации агентства. Горящие туры, опубликованные агентством, доступны туристам только из региона регистрации агентства.',
    'Лицензия Вся страна – активирует все сервисы для всех регионов страны регистрации Авиа/Тур агентства. Позволяет работать с туристами всех регионов страны регистрации агентства. Агентство получает в свой кабинет запросы на туры и авиаперелет, отправленные туристами из всех регионов страны регистрации агентства. Горящие туры, опубликованные агентством, доступны всем туристам из страны регистрации агентства.' => 'Лицензия Вся страна – активирует все сервисы для всех регионов страны регистрации Авиа/Тур агентства. Позволяет работать с туристами всех регионов страны регистрации агентства. Агентство получает в свой кабинет запросы на туры и авиаперелет, отправленные туристами из всех регионов страны регистрации агентства. Горящие туры, опубликованные агентством, доступны всем туристам из страны регистрации агентства.',
    'License "Region" will be expired to' => 'Лицензия "Регион" будет активна до',
    'License "Country" will be expired to' => 'Лицензия "Вся страна" будет активна до',
    'New user registered' => 'Регистрация нового пользователя',
    'New hot tour created' => 'Создан новый горящий тур',
    'New tour response created' => 'Новое предложение тура',
    'New flight response created' => 'Новое предложение авиабилета',
