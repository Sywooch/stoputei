...
//search list of hotels
    ...
    $('.field-createhottourform-hotel .remove-hotel-name').on('click', function(){
        $('#createhottourform-hotel_id').val('');
        $('#createhottourform-hotel').val('').removeAttr('data-toggle title data-original-title');
        $('.field-createhottourform-hotel_type, .field-createhottourform-beach_line').removeClass('disabled');
